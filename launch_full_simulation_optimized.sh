...
print_header "🤖 STRETCH ROBOT FULL SIMULATION - OPTIMIZED"
...
ros2 run robot_state_publisher robot_state_publisher \
    ...
    -p robot_description:="$(cat /home/user/ament_ws/install/stretch_description/share/stretch_description/urdf/stretch.urdf)" &
RSP_PID=$!
sleep 3
